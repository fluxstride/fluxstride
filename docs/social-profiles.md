...
- [Bios by length](#bios-by-length)
- [Platform by platform](#platform-by-platform)
- [Images](#images)
...
| Location          | [City], United Kingdom · remote across UK & Europe                                        |
...
Product design (UI/UX) · Graphic design & branding · Website design & frontend development · Mobile development · Backend development · Cloud & DevOps

**Link menu** (for a link-in-bio page, or as the profile's link buttons):
...
- Book a 20-minute intro call → [booking link]
- Read The Stride, monthly notes on software & design → fluxstride.com/insights
...
Websites · Apps · Platforms · Brands
Senior team, fixed scope, weekly demos
↓ Start a project
```
...
> Senior design & engineering studio. We design products and brands, build the web, mobile and backend behind them, and run it in the cloud. (138)

**Facebook short description (≤255)**

> Fluxstride is a senior design and engineering studio. We design products and brands, build the websites, apps and backends behind them, and keep them running in the cloud. Fixed scope, weekly demos, senior people on every project. (230)

**Long about (LinkedIn "About", Facebook "More info", YouTube "Description", Clutch, Google Business)**

> Fluxstride is a design and engineering studio. We build digital products that keep moving.
>
...
>
> Start a project: hello@fluxstride.com · fluxstride.com
> Join the team: fluxstride.com/careers

Trim the middle for shorter fields; keep the first line and the last two.

**Hiring variant** (for a profile's hiring highlight, or a careers-focused post pinned to the top)

> We're hiring. Remote-first, four-day focus weeks, 30 days off and profit share. Open roles: fluxstride.com/careers
...
| ------------- | ------------------------------------------------------------------------------------------------------------ |
| Name          | Fluxstride                                                                                                   |
| Public URL    | linkedin.com/company/fluxstride                                                                              |
| Tagline (120) | as above                                                                                                     |
| About         | Long about, as above                                                                                         |
| Website       | fluxstride.com/?utm_source=linkedin                                                                          |
| Industry      | Software Development (secondary: Design Services)                                                            |
| Company size  | 11–50 employees                                                                                              |
| Type          | Privately held                                                                                               |
| Founded       | 2019                                                                                                         |
| Headquarters  | [City], United Kingdom                                                                                       |
| Specialties   | The six service names, plus: e-commerce, technical SEO, design systems, API integration, AWS, React, Next.js |
| Custom button | "Visit website" → /contact                                                                                   |
| Featured      | Three case studies from /work, newest first                                                                  |
| Hashtags      | #softwaredevelopment #productdesign #uiux                                                                    |
| Life tab      | The careers page words: four-day focus weeks, remote-first, profit share                                     |
...
| Name     | Fluxstride                                                |
| Bio      | X bio, as above                                           |
| Location | [City], UK · Remote                                       |
| Website  | fluxstride.com/?utm_source=x                              |
| Pinned   | A thread from the newest case study, ending with the link |
...
| ----------------- | --------------------------------------------------------------- |
| Name              | Fluxstride                                                      |
| Username          | facebook.com/fluxstride                                         |
| Category          | Software Company · Web Designer                                 |
| Short description | Facebook description, as above                                  |
| More info         | Long about, as above                                            |
| Button            | Contact us → /contact                                           |
| Hours             | Mon–Fri 9:00–18:00                                              |
| Email             | hello@fluxstride.com                                            |
| Services          | The six services, each with its one-line summary from /services |
...
| Handle           | @fluxstride                                                          |
| Name             | Fluxstride                                                           |
| Description      | Long about, plus: "New build logs and guides every [weekday]."       |
| Links            | Website, LinkedIn, Instagram, X, newsletter                          |
| Banner           | `04-social/banners/youtube-banner-*`                                 |
| Channel keywords | design studio, ui ux, web development, next.js, case study, branding |

### Dribbble / Behance (design work)

| Field    | What to put                                                |
| -------- | ---------------------------------------------------------- |
| Name     | Fluxstride                                                 |
| Bio      | Ultra-short or short bio, as above                         |
| Location | [City], United Kingdom                                     |
| Skills   | UI/UX, branding, design systems, web design, mobile design |
| Links    | Website + LinkedIn                                         |
| Hiring   | Switch "available for work" on while you have capacity     |
...
| --------- | ------------------------------------------------ |
| Name      | Fluxstride                                       |
| Bio (160) | Short bio, as above                              |
| URL       | fluxstride.com                                   |
| Email     | hello@fluxstride.com                             |
| README    | Long about, the services list and a careers link |
...
| Photos       | Studio photo, logo, three case study covers                      |
...
All in `brand-assets/04-social/`:

| Use                        | File                                                           |
| -------------------------- | -------------------------------------------------------------- |
| Avatar (light backgrounds) | `profile-and-highlights/social-avatar-dark.png`                |
| Avatar (colour)            | `profile-and-highlights/social-avatar-blue.png`                |
| Avatar (dark UI)           | `profile-and-highlights/social-avatar-light.png`               |
| LinkedIn cover             | `banners/linkedin-company-cover-*`                             |
| X header                   | `banners/x-header-*`                                           |
| Facebook cover             | `banners/facebook-cover-*`                                     |
...
People post more than pages do, so their posts are where the studio is actually seen. Encourage reposts of case studies and roles, in their own words.
...
- [ ] Handle is `@fluxstride`
- [ ] Avatar and banner from `04-social/`
- [ ] Bio at the right length, from this file
- [ ] Website link with its `utm_source`
